...
# {\large}{\thesubsection}{1em}{\textbf{#1}} \titlespacing\subsection{0pt}{5pt}{-5pt} % left margin, space before subsection header, space after subsection header

# #+LATEX_HEADER: \titleformat{\subsubsection}
# {\large}{\thesubsubsection}{1em}{#1} \titlespacing\subsubsection{0pt}{5pt}{-5pt}
